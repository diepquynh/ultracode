---
description: Spawn ultracode:implement directly — write code for one plan phase, or for inline instructions on a low-stakes task.
argument-hint: "[phase number or phase file path] | [inline instructions]"
---
...
**Spawn the prefixed name** — `subagent_type: ultracode:implement`, verbatim.
