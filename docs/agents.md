...
No agent waits on the hub. A listening session ends its turn and the harness wakes it: a native push channel
on Claude Code and Codex, its own backgrounded long-poll command on Antigravity and Grok Build. See
docs/hub.md, "Waiting without parking".
